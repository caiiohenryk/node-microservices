...
INSERT INTO "new_Order" ("id", "order_date", "product_id", "product_quantity", "shipping_adress") SELECT "id", "order_date", "product_id", "product_quantity", "shipping_adress" FROM "Order";
DROP TABLE "Order";
